...
const getCheckBox = getMyForm.querySelectorAll(".elementor-field-group-setp001 .elementor-field-subgroup  input");
const getButtonHide = document.querySelector(".btn-inner-01");
const getNextBtn = getMyForm.querySelector(".e-form__buttons__wrapper__button-next");
const getText = getMyForm.querySelector(".elementor-field-group-setp002 .elementor-field-group-field_c72494c");
const getRadio = getMyForm.querySelector(".elementor-field-group-setp002 .elementor-field-group-field_c6b3e2d");
const getFormTitle = getMyForm.querySelector(".elementor-field-group-setp002 .elementor-field-group-field_45e2788");
const getFormf1 = getMyForm.querySelector(".elementor-field-group-setp002 .elementor-field-group-name");
const getFormf2 = getMyForm.querySelector(".elementor-field-group-setp002 .elementor-field-group-mail");
const getFormf3 = getMyForm.querySelector(".elementor-field-group-setp002 .elementor-field-group-phone");
    ...
    for (let redio of redioList) {
        if (redio.checked) {
            if (redio.value = "Thunder Bay") {
                ...
                window.location.href = "https://ccfph.janeapp.com/locations/ccfph-consultations/book#/discipline/2/treatment/106";
            } else if (redio.value = "Sault Ste Marie") {
                console.log(redio.value);
                window.location.href = "https://ccfph.janeapp.com/locations/ccfph-consultations/book#/discipline/2/treatment/107";
            }
        }
    }
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const accords = document.querySelector('.faq-x1 .elementor-widget-container .e-n-accordion');
...
//-----------------------------------------------------------------------
document.addEventListener('DOMContentLoaded', () => document.querySelector('.ac-mega-button').addEventListener('click', () => document.querySelector('.mega-menu-container-001').classList.toggle('show')));
...
function priceLoad() {
    ...
    if (getSelector.value === getOptions[0].value) {
        ...
        getDelivery.innerHTML = countWords(getSelector.value) + ' - ' + imageQuntity + ' X ' + getData;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let imageList = ['/wp-content/uploads/2024/03/upstairs.jpg', '/wp-content/uploads/2024/03/ENTREES.jpg', '/wp-content/uploads/2024/03/main.jpg', '/wp-content/uploads/2024/03/DESSERTS.jpg', '/wp-content/uploads/2024/03/Cocktails.jpg', '/wp-content/uploads/2024/03/Wine-Cellar.jpg'];
    ...
    tabBtns.forEach((tab, index) => {
        tab.addEventListener('click', () => {
            ...
            tabBtns.forEach(button => {
                button.querySelector('.elementor-widget-container').style.backgroundColor = '#FFFFFF99';
            });
            ...
            if (index > 0) {
                tab.querySelector('.elementor-widget-container').style.backgroundColor = '#ABA26D';
            };
    ...
    translet.addEventListener("click", () => {
        if (english) {
            ...
            translet.querySelector('.elementor-heading-title').textContent = 'ENGLISH';
            english = true;
        }
    });
    ...
    function changeimage() {
        let activeImage = getImageCerosol.querySelector('.swiper-slide-active .swiper-slide-inner img');
...
sliderNavItems.forEach((navItem, index) => {
    navItem.addEventListener('click', () => {
        ...
        topContent.forEach(item => {
            item.style.top = '-20px';
            item.style.transition = 'top 0.5s ease-in-out, opacity 2s ease-in-out 1.5s';
        });
...
mainCon.forEach(item => {
    item.addEventListener('mouseover', () => {
        ...
        const [conInner, conIcon, text] = [item.querySelector('.button-inner'), item.querySelector('.con-icon'), item.querySelector('.text-001')];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const num = document.querySelector('.the_number .post-views-count').textContent;
    const length = 9;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const dashboardObserver = new IntersectionObserver(entries => {
        entries.forEach(entry => {
            const dashboardBackAnimation = document.querySelector('.dashboard-back-animation');
            if (entry.isIntersecting) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function imagesOpen() {
        var textElement = document.querySelector('.elementor-slideshow__description');
...
document.addEventListener("DOMContentLoaded", function () {
    function clickElement() {
        const firstLoopItem = document.querySelector('[data-filter="highlights-en"]');
        firstLoopItem.click()
...
//
const images = document.querySelectorAll('#gallery-horizontal-scroll-comp-lzkh52e91 .item-link-wrapper picture source');
let all = [];
images.forEach((item) => {
...
const cardQuantity = parseInt(cardIcon.querySelector('.elementor-button-icon').getAttribute('data-counter'));
...
const data = [
    {
        ...
        details: 'Har du en trasig Smartphone, Surfplatta, Smart watch eller Dator?',
...
const theNumber = document.querySelectorAll('.elementor-shortcode > .show-the-number-here span');
const itemsNumber = document.querySelectorAll('.elementor-shortcode .e-loop-item .show-the-number-here span');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function contentAnimated(content) {
        content.style = 'transition: all 1s linear; transform: translate3d(0px, 24px, 0px) scale3d(0.8, 0.8, 1); transform-style: preserve-3d; opacity: 0;'
        setTimeout(() => {
            content.style = 'transition: all 1s linear; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); transform-style: preserve-3d; opacity: 1;'
        }, 800);
    }
    ...
    projectBoxes.forEach((topBlockBox) => {
        ...
        topBlockBox.addEventListener('mouseout', () => {
            ...
            blackBg.addEventListener('transitionend', () => {
                blackBg.style.transform = 'translateY(-65px)';
            }, { once: true });
        });
    });
    ...
    const newSliderContent = newSliderContainer.querySelector('.new_slider_content');
    const newHeadingElements = newSliderContent.querySelector('.new_slider_heading h2');
    const newTitleElements = newSliderContent.querySelector('.new_slider_title h2');

    const newDataArray = [
        {
            heading: 'Vrtání studen',
            title: 'Provádíme profesionální vrtání studen s důrazem na přesnost a kvalitu. Naše technologie umožňuje rychlé a efektivní vrty s minimálním zásahem do okolí. Zajistíme vám spolehlivý zdroj čisté vody přímo na vašem pozemku.'
        },
        {
            heading: 'průzkum podlaží',
            title: 'Provádíme detailní hydrogeologické průzkumy, které určují ideální místo a hloubku vrtu. Analyzujeme podloží, aby byl zajištěn optimální přístup k vodě. Naše odborné služby garantují přesné a efektivní výsledky, které minimalizují rizika.'
        },
        {
            heading: 'Legislativní poradenství',
            title: 'Zajišťujeme kompletní legislativní podporu pro realizaci vašeho projektu. Pomůžeme vám s vyřízením všech potřebných povolení a dokumentace. Díky našim znalostem a zkušenostem zvládneme celý proces rychle a bez zbytečných komplikací.'
        },
        {
            heading: 'Montáž a servis čerpadel',
            title: 'Nabízíme profesionální montáž a servis čerpadel pro dlouhodobě bezproblémový provoz. Zajišťujeme instalaci moderních čerpacích systémů, které jsou přizpůsobeny vašim potřebám. Pravidelný servis zajistí jejich dlouhou životnost a maximální účinnost.'
        }
    ];
...
const getNewAllCon = document.querySelectorAll(".new_slider_content .content_con");

// get all slider part
const getNewSliderCon = document.querySelectorAll(".new_slider_container .new_custom_slider");

// get Arrows 
const getNewArrowPrev = document.querySelector('.new_slider_container .new_prev_arrow');
const getNewArrowNext = document.querySelector('.new_slider_container .new_next_arrow');

let newTemp1, newTemp2, newTemp3, newTemp4, newTemp5, acIndex = 0, tempUp = false;
...
const priceBtn = document.querySelectorAll('.cfvsw-product-container .cfvsw-swatches-option');
...
const images = document.querySelectorAll('.galary_images .elementor-gallery__container .e-gallery-item');
